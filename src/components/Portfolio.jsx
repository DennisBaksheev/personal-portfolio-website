...
const Portfolio = () => {
  ...
  const portfolios = [
  ...
  
    {
      ...
      stack: ["ASP.NET", "C#", "Entity Framework", "Microsoft Azure"],
...

    {
      ...
      stack: ["JavaScript", "React", "Tailwind CSS", "Netlify"],
...

    {
      ...
      stack: ["Node.js", "Express.js", "MongoDB", "Mongoose", "EJS", "Google Books API", "Google OAuth", "Passport.js", "Axios"],
